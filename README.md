...
> También tenemos un prototipo preliminar de UX y de UI de la enfermera conectado al Backend con funcionalidad limitada.  ([Dar clic aquí](http://chkt-en-linea-enfermera.herokuapp.com/)), el repositorio esta aquí ([Dar clic aquí](https://github.com/VoltStudios/chkt-online-web-enfermera.git)) y usuario para prueba aquí ([Dar clic aquí](https://github.com/VoltStudios/CHKT-Instrucciones-uso-Propuesta/wiki/Usuario-de-Prototipo-Enfermera)).
> 
